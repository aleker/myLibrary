...
urlpatterns = [
    ...
    url(r'^mybooks/delete/(?P<pk>\d+)$', views.BookInstanceDelete.as_view(), name='users_books_delete_url'),
    url(r'^mybooks/edit/(?P<pk>\d+)$', views.BookInstanceUpdate.as_view(), name='users_books_update_url'),
